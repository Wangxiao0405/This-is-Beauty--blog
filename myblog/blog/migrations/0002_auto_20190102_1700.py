# Generated by Django 2.1 on 2019-01-02 09:00
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.IntegerField(choices=[(0, '普通用户'), (1, '高级用户'), (1, '超级管理员')], default=0, verbose_name='用户类型')),
        ...
        migrations.AlterModelOptions(
            name='category',
            options={'verbose_name': '网站种类', 'verbose_name_plural': '网站种类'},
        ),
        migrations.AlterModelOptions(
            name='info',
